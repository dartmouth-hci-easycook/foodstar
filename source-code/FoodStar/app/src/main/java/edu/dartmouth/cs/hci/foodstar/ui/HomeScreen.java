...
public class HomeScreen extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(R.string.tab_label_starred);
                case 1:
                    return getString(R.string.tab_label_recommendation);
                case 2:
                    return getString(R.string.tab_label_trending);
            }
            return null;
        }
    }
